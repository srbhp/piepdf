...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.splitter.setSizes(
            [int(self.splitter.height() * 0.05), int(self.splitter.height() * 0.95)]
        )
...
class Pdf_Widget(QtWidgets.QMainWindow):
    ...
    def goToPage(self):
        try:
            ...
            self.sliderBar2.setValue(int(loc))
        except:
    ...
    def thubmClick(self, pos):
        ...
        factor = self.ui.pdfwidget.height() / (1.0 * self.ui.thumbWidget.height())
